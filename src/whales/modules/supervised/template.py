...
class Demo(Supervised):
    ...
    def method_fit(self):
        # Here goes the training, depending on the method. Supervised methods usually take data and target inputs
        # for training. Works if needs_fitting is True.
        pass

    def method_predict(self):
        # Here goes the prediction method. Supervised methods usually take in data input for predicting
        return None
